...
public class MeterDetails extends JFrame implements ActionListener {
   ...
   MeterDetails() {
        ...
        JLabel title = new JLabel("YOUR METER INFORMATION");
        title.setBounds(250, 0, 500, 40);
        title.setFont(new Font("Tahoma", Font.PLAIN, 20));
        add(title);

        JLabel l1 = new JLabel("Meter Location");
      ...
      ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/viewcostumer1.png"));
